function out=pulser_opticalEncoder2(src,event)
...
s1 = serial('COM3');            % define your serial port (just get it from the arduino ide)
s1.BaudRate=38400;               % Baud rate of 38400 works well in testing, I haven't tried anything else
